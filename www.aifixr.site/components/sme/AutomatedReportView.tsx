...
import { TotalResultsView } from '@/components/sme/TotalResultsView';
import { CompanyInfoInput } from '@/components/sme/CompanyInfoInput';
import type { ESGStandard } from '@/components/sme/types';
import type { MainTab, ResultsSubTab, InputSubTab, MonthlyESGData, CompanyESGData } from '@/components/sme/types/navigation';
        ...
        <SidebarInset>
          ...
          <main className="flex-1 overflow-auto">
            <div className="container mx-auto px-6 py-8 max-w-7xl">
              {/* Header - 메인 콘텐츠 영역 안에 포함 */}
              <div className="flex h-16 items-center gap-4 mb-6">
                <SidebarTrigger />
