      ...
      try {
        ...
        if (accessToken && refreshToken) {
          ...
          const userInfo = {
            ...
            name: searchParams.get('nickname') || null,
            nickname: searchParams.get('nickname') || null,
            picture: searchParams.get('profileImage') || null,
        ...
        const userInfo = {
          ...
          name: data.user?.nickname || data.user?.name || null,
          nickname: data.user?.nickname || null,
          picture: data.user?.profileImage || data.user?.picture || null,
          profileImage: data.user?.profileImage || null,
          provider: data.user?.provider || 'kakao',
        };
