...
import site.aifixr.api.oauthservice.naver.dto.NaverTokenResponse;
import site.aifixr.api.oauthservice.naver.dto.NaverUserInfo;
...
public class NaverService {
    ...
    public NaverTokenResponse getAccessToken(String code, String state) {
        ...
        params.add("redirect_uri", naverConfig.getRedirectUri());
        ...
        try {
            String tokenUri = naverConfig.getTokenUri();
            if (tokenUri == null) {
    ...
    public NaverUserInfo getUserInfo(String accessToken) {
        ...
        String userInfoUri = naverConfig.getUserInfoUri();
        if (userInfoUri == null) {
